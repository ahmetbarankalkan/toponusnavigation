          ...
          <div className="bg-white rounded-lg shadow-sm p-6">
            ...
            <div className="relative mb-4 search-container">
              <input
                ...
                className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-brand-light0"
              />
                ...
                <div className="absolute z-50 w-full mt-1 bg-white border border-gray-300 rounded-lg shadow-lg max-h-60 overflow-y-auto">
                  {searchResults.map((room) => (
                    <div
                      ...
                      className="px-4 py-2 cursor-pointer hover:bg-brand-light border-b last:border-b-0"
                    >
                      <div className="flex justify-between items-center">
                        <span className="font-medium">{room.name}</span>
                        <span className="px-2 py-1 bg-brand-light text-brand-darkest text-xs rounded">Kat {room.floor}</span>
                      </div>
                    </div>
                  ))}
                </div>

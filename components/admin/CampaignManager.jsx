                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    ...
                    <div className="flex items-center gap-4 text-sm text-gray-500">
                      {campaign.discount_percentage && (
                        <span className="bg-brand-light text-brand-darkest px-2 py-1 rounded">
                  ...
                  <div className="flex gap-2 ml-4">
                    <button
                      ...
                      className="px-2 py-1 bg-brand text-white text-xs rounded hover:bg-brand-dark transition-colors"
                    >
                      Düzenle
                    </button>
                    <button
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex gap-2 pt-4">
              <button
                ...
                className="px-4 py-2 bg-brand text-white rounded-md hover:bg-brand-dark disabled:bg-gray-400 disabled:cursor-not-allowed transition-colors"
              >
                {loading
                  ? 'Kaydediliyor...'
                  : editingCampaign !== null
